 ...
 <div id="sidebar" class="active">
   ...
   <div class="sidebar-header position-relative">
    <div class="d-flex justify-content-between align-items-center">
     <div class="logo ms-auto me-auto">
      <a href="index.html"><img id="logo-ub" src="assets/img/ub_theme-dark.png" alt="Logo" srcset=""  style="height: 30px"> </a>
     </div>
  ...
  <div class="sidebar-menu">
   <ul class="menu">
    ...
    <li class="sidebar-item {{ ($page == 'news') ? 'active' : '' }}">
    ...
    <li class="sidebar-item {{ ($page == 'visitor') ? 'active' : '' }}">
      <a href="/visitor" class='sidebar-link'>
      <i class="bi bi-person-heart"></i>
      <span>Visitor</span>
      </a>
    </li>
    <li class="sidebar-item {{ ($page == 'content') ? 'active' : '' }}">
